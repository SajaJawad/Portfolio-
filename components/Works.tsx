                ...
                <div className="px-4 sm:px-6 pb-5 sm:pb-6 pt-4 border-t border-border/50 flex flex-wrap items-center justify-between gap-2.5 sm:gap-3">
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 px-3.5 sm:px-4 py-2 rounded-xl bg-primary text-primary-foreground text-[11px] sm:text-xs font-semibold hover:bg-primary-hover transition-colors shadow-subtle whitespace-nowrap shrink-0"
                    >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {project.liveUrl && (
                      <a
                        ...
                        className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-xl border border-border bg-background text-[11px] font-medium text-muted-foreground hover:text-primary hover:border-primary/40 transition-colors shrink-0"
                      >
                        <Globe className="w-3.5 h-3.5" />
                        <span className="hidden sm:inline">{language === "ar" ? "الموقع الحي ↗" : "Visit Website ↗"}</span>
                      </a>
                    )}
                    {project.githubUrl && (
                      <a
